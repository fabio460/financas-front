...
import DarkModeSwitches from './btnDarkMode';
import LocalAtmIcon from '@mui/icons-material/LocalAtm';
const pages = ['Products', 'Pricing', 'Blog'];

function ResponsiveAppBar({usuario, dark, setDark}:{usuario:usuarioLogadoType, dark:any, setDark:any}) {
  ...
  const n = useNavigate() 
  const settings:any = [<div>{usuario.nome}</div>, <div>{usuario.email}</div>, <ModalDeletarUsuario deletarUsuario={deletarUsuario}/>, Sair()];
...
function Sair() {
    ...
    return <div onClick={logouf}>Sair</div>
  }  
  return (
    <AppBar position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <DarkModeSwitches dark={dark} setDark={setDark}/>
